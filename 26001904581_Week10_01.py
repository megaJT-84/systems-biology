...
referenceData = np.array([[0,1,0,1]]).T # desired output data, which will be used as reference for training in backporpagation algorithm

training_num = 2500 #set a number for the training iterations
...
print("output values after " + str(training_num) + " training iterations")
print(out_rounded)